...
\begin{figure}[H]
    ...
    \caption{\textbf{Dual-laser configuration for multiple opsin stimulation and real-time imaging.} The Zapit system can be assembled to mount two lasers, both of which can be controlled within one experiment. An additional dichroic (Thorlabs) is needed to merge the two beams before the scanners. Resulting fluorescence passes through the chosen emission filter (Chroma). Ongoing changes to Zapit will allow for dual-laser control in the future.}
