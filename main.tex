...
% While optogenetic actuators can accommodate millisecond-precision control over genetically defined neural populations, successful optogenetics experiments also critically depend on associated optical hardware for precise spatiotemporal targeting of light delivery. 

% Optical fibres are suitable for certain experiments, but fibre implantation can be invasive and limits flexibility of spatial targeting. In contrast, galvonometer-based laser-scanning optogenetic systems facilitate far greater flexibility for targeting distributed cortical areas. Yet no open source systems are available at present, and building such bespoke photostimulation systems can be technically challenging and expensive.

% Here we present Zapit, a complete open source hardware and cross-platform software system for spatio-temporally precise laser-scanning optogenetics in head-fixed mice. 
...
Optic-fibres are suitable for certain experiments, however fibre implantation can be invasive and limits flexibility of spatial targeting. 
...
We thank Morio Hamada for providing feedback on the manuscript. 
