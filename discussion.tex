...
DMD-based approaches provide the fastest pattern-switching time but are very wasteful of light and so require a roughly 4 W laser to cover an area the size of mouse dorsal cortex. 
...
Scanner-based approaches provide the most cost-effect and compact solution. 